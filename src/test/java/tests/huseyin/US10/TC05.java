...
public class TC05 {
    ...
    public void test01(){
        ...
        // Enter Invalid Username and Invalid Password then Click to the Login button
        ...
        softAssert.assertTrue(userLoginPage.slideInBox.isDisplayed(), "Invalid Login Notification is not displayed");
