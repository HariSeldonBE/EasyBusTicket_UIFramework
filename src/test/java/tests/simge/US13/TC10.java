...
public class TC10 extends TestBaseRapor {
    ...
    public void nameOnCardNegatifTestiBosluk(){
        extentTest=extentReports.createTest("Name on Card Negatif Test", "Name on Card bölümüne bosluk giriliyor");
        ...
        // 24"Name on Card" textbox ına bosluk yazılır
        selectSeatPage.nameOnCard.sendKeys(" ");
        ReusableMethods.wait(2);
        extentTest.info("\"Name on Card\" textbox ına bosluk yazılır");
