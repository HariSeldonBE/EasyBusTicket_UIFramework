...
public class TC14 {
    @Test
    public void validCardNumberNegatifTestiGecersiz(){
        ...
        // 25-"Card Number" textbox ına 4 ile başlamayan 16 haneli geçersiz kart numarası girilebildiği doğrulanır
        selectSeatPage.validCardNumber.sendKeys("2056175254135689");
