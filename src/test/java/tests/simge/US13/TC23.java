...
public class TC23 {
    @Test
    public void cvcCodeNegatifTestiBoslukHiclikKarakterHarfGirisi(){
        ...
        //16-"CVC Code" textbox ına bosluk/hiclik/karakter/harf girilir
        selectSeatPage.cvcCode.sendKeys(" ");
        selectSeatPage.cvcCode.sendKeys("");
        selectSeatPage.cvcCode.sendKeys("*");
        selectSeatPage.cvcCode.sendKeys("a");
