...
public class TC08 extends TestBaseRapor {
    @Test
    public void nameOnCardNegatifTestiRakam(){
        extentTest=extentReports.createTest("Name on Card Negatif Rakam Testi", "Name on Card yerine isim yerine rakamlar giriliyor");
        ...
        ReusableMethods.wait(2);
        extentTest.info("\"Name on Card\" textbox ına rakamlar yazılır");
        ...
        ReusableMethods.wait(2);
        // 29 -Booking History sayfasında alınan bilet status durumu "Rejected" olarak görüntülenir
        Object expected = "Rejected";
        softAssert.assertEquals(selectSeatPage.status.getText(),expected,"Bug var");
        extentTest.info("Booking History sayfasında alınan bilet status durumu \"Rejected\" olarak görüntülenir");
