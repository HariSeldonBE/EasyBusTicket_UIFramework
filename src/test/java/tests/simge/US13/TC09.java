...
public class TC09 extends TestBaseRapor {
    ...
    public void nameOnCardNegatifTestiKarakter(){
        extentTest=extentReports.createTest("Name on Card Negatif Test", "Name on Card alanına karakter giriliyor");
        ...
        ReusableMethods.wait(1);
        extentTest.info("\"pay now\" butonu tıklanır");
        // 24-"Name on Card" textbox ına karakter yazılır
        selectSeatPage.nameOnCard.sendKeys("*._?");
        ReusableMethods.wait(2);
        extentTest.info("\"Name on Card\" textbox ına karakter yazılır");
