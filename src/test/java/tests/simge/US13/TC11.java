...
public class TC11 extends TestBaseRapor {
    @Test
    public void nameOnCardNegatifTestiHiclik(){
        extentTest=extentReports.createTest("Name on Card Negatif Test", "Name on Card alanına hiçbirşey yazılmaz");
        ...
        // 24-"Name on Card" textbox ına hiçbirşey yazılmaz
        selectSeatPage.nameOnCard.sendKeys("");
        ReusableMethods.wait(2);
        extentTest.info("\"Name on Card\" textbox ına hiçbirşey yazılmaz");
