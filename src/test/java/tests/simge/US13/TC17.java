...
public class TC17 {
    @Test
    public void expirationDateNegatifTestiIleriYilGirisi(){
        ...
        //14 - "Expiration Date" textbox ına "MM/YYYY" formatında çok ileri tarih girilir (01-12/2075)
        selectSeatPage.expirationDate.sendKeys("01/2075");
