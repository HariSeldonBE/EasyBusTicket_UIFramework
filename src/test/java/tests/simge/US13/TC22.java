...
public class TC22 extends TestBaseRapor {
    @Test
    public void cvcCodeNegatifTesti4HaneliSayiGirisi(){
        extentTest=extentReports.createTest("CVC Code Negatif Test", "CVC Code alanına 4 haneli sayı giriliyor");
       ...
       ReusableMethods.seatSelectionMethod();
        ...
        extentTest.info("\"CVC Code\" textbox ına 4 haneli sayi girilir");
