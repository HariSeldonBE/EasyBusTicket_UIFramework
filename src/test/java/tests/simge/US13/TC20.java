...
public class TC20 {
    @Test
    public void expirationDateNegatifTestiGecersizAyGirisi(){
        ...
        selectSeatPage.seats.get(12).click();
        ...
        // 26 - "Expiration Date" textbox ına "MM/YYYY" formatında gecersiz ay girilir (00-13/2024)
        selectSeatPage.expirationDate.sendKeys("00/2024");
