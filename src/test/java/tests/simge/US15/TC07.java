...
public class TC07 {
    @Test
    public void createNewSubjectBoslukHiclikNegatifTesti(){
        ...
        //Subject yazılır
        supportRequestPage.subject.sendKeys("");
        //Priority seçilir
        supportRequestPage.priority.click();
        supportRequestPage.low.click();
        ReusableMethods.wait(1);
        //Mesaj yazılır
        supportRequestPage.message.sendKeys("Merhaba, deneme amaçlı ilk mesaj.");
        ...
        ReusableMethods.wait(1);
        //Mesaj yazılır
        supportRequestPage.message.sendKeys("Merhaba, deneme amaçlı ikinci mesaj.");
