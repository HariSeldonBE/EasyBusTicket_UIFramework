...
public class TC13 {
    ...
    public void test01(){
        ...
        softAssert.assertEquals(actualEBTUrl,expectedEBTUrl, "Easy Bus Ticket Home Page is not displayed");
//***************************************************************************************************************************
//        Choose Your Ticket Panel Test
        softAssert.assertTrue(easyBusTicketPage.homePagePickUpPointContainer.isDisplayed(), "Pickup Point Container is not displayed");
        softAssert.assertTrue(easyBusTicketPage.homePagePickUpPointContainer.isEnabled(), "Pickup Point Container is not enabled");
