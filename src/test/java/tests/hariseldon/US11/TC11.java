...
public class TC11 {
    ...
    public void test01(){
        ...
        softAssert.assertEquals(actualEBTUrl,expectedEBTUrl, "Easy Bus Ticket Home Page is not displayed");
//***************************************************************************************************************************
        // Contact link in Home Page Header Display Test
        softAssert.assertTrue(easyBusTicketPage.contactButton.isDisplayed(), "Contact link in header is not displayed");
        // Contact link in Home Page Header Enable Test
