...
//*********************  FAQs Link in Home Page Footer Display Test  **************************************************
        //
        softAssert.assertTrue(easyBusTicketPage.footerFAQsButton.isDisplayed(), "FAQs Link in Home Page Footer is not displayed");
