...
public class TC09 {
    ...
    public void test01(){
        ...
        softAssert.assertEquals(actualEBTUrl,expectedEBTUrl, "Easy Bus Ticket Home Page is not displayed");
//***************************************************************************************************************************
        // FAQs link in Home Page Header Display Test
        softAssert.assertTrue(easyBusTicketPage.headerFAQsButton.isDisplayed(), "FAQs link in header is not displayed");
        // FAQs link in Home Page Header Enable Test
        softAssert.assertTrue(easyBusTicketPage.headerFAQsButton.isEnabled(), "FAQs link in header is not enabled");

        easyBusTicketPage.headerFAQsButton.click();
        String actualFAQUrl = Driver.getDriver().getCurrentUrl();
        String expectedFAQUrl = "https://qa.easybusticket.com/faq";

        // About Page Url Test
        softAssert.assertEquals(actualFAQUrl,expectedFAQUrl, "FAQs Page is not displayed");
