...
public class TC07 {
    ...
    public void test01(){
        ...
        // Easy Bus Ticket Home Page Url Test
        softAssert.assertEquals(actualEBTUrl,expectedEBTUrl, "Easy Bus Ticket Home Page is not displayed");
        // Home link in Home Page Header Display Test
        softAssert.assertTrue(easyBusTicketPage.homeLink.isDisplayed(), "Home link in header is not displayed");
        // Home link in Home Page Header Enable Test
        softAssert.assertTrue(easyBusTicketPage.homeLink.isEnabled(), "Home link in header is not enabled");

        easyBusTicketPage.homeLink.click();
